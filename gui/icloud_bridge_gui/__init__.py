...
# honest statement of that (AGENTS.md hard rule 9). The minor digit tracks the
# design line the code implements -- 0.2.x is the v2 plan. This string is the one
# version source in the repository; the Makefile and packaging/build-deb.sh read
