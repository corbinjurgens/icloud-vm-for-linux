...
`docs/plan-gui-selective-sync.md` are the decisions they added). Item 10 was
decided (rejected) the same day and is archived alongside them, with the
rejection recorded as R-040 in `CHANGELOG.md`. Items 1-2 and item 9's beacon
still await their live pass on the real host. What remains below is item 3
(operator chose live instrumentation before any fix, asked 2026-07-28).
